...
display_restore_stats() {
  ...
  ssh -i $pem_file ubuntu@$first_node "bash ${remote_node_script_dir}/display_stats.sh $table_name"
}
...
# table_name="files_perf_test_only"
# table_name=$1
display_restore_stats $table_name
...
db_result_dir="$result_dir/db_result"
rm -rf $db_result_dir
...
########################################################################
find_diff_for_table $table_name $db_result_dir extra_entries_file missing_entries_file mismatching_entries_file
...
missing_entries_vs_deduped_file="$combined_result_dir/missing_entries_vs_orig_cdc.json"
python3 skip_commit/verify_cdc/restore_debug/find_cdc_entries_for_diff_entries.py $missing_entries_file $combined_orig_cdc_json_file $missing_entries_vs_deduped_file
echo "3. missing_entries_vs_deduped_file: $missing_entries_vs_deduped_file"
