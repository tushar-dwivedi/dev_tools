...
display_restore_stats() {
  ...
  sudo /opt/rubrik/src/scripts/cockroachdb/rkcockroach sql -e "select count(*) from sd.${table_name}"
  sudo /opt/rubrik/src/scripts/cockroachdb/rkcockroach sql -e "select count(*) from sd_restore.${table_name}"

  sudo /opt/rubrik/src/scripts/cockroachdb/rkcockroach sql -e "select count(*) from sd.${table_name}__static"
  sudo /opt/rubrik/src/scripts/cockroachdb/rkcockroach sql -e "select count(*) from sd_restore.${table_name}__static"
