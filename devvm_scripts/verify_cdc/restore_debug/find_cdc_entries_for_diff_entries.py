...
for item in data1:
    ...
    if key in data_dict:
        ...
        matched_entry = {
            ...
            'check_orig_cdc_command': "sudo z{} {} | {}".format(grep_cmd_1, "/mnt/wwn-f*/internal/cassandra_snapshots/intermediate_cdc_data/cdc_orig/*", grep_cmd_2),
            'check_dedup_cdc_command': "sudo z{} {} | {}".format(grep_cmd_1, "/mnt/wwn-f*/internal/cassandra_snapshots/cdc_data/compressed/*", grep_cmd_2),
