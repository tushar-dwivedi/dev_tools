...
find_diff_for_table() {
  ...
  # result variables
  local __extra_entries_file=$3
  local __missing_entries_file=$4
  local __mismatching_entries_file=$5

  extra_entries_query_select="SELECT t1.* FROM sd_restore.$table_name AS t1 LEFT JOIN sd.$table_name AS t2 "
  missing_entries_query_select="SELECT t1.* FROM sd.$table_name AS t1 LEFT JOIN sd_restore.$table_name AS t2 "
  ...
  mismatch_entries_query_select="SELECT $sql_query_select_for_mismatch FROM sd.$table_name AS t1 JOIN sd_restore.$table_name AS t2 "
...
# find_diff_for_table "files_perf_test_only" $db_result_dir extra_entries_file missing_entries_file mismatching_entries_file
...
# find_diff_for_table "files_perf_test_only__static"
